...
| <a name="input_cloudfront_geo_restricted_locations"></a> [cloudfront\_geo\_restricted\_locations](#input\_cloudfront\_geo\_restricted\_locations) | List of countries to block from CloudFront Distribution | `list(string)` | `null` | no |
| <a name="input_cloudfront_minimum_protocol_version"></a> [cloudfront\_minimum\_protocol\_version](#input\_cloudfront\_minimum\_protocol\_version) | CloudFront minimum TLS protocol version | `string` | `null` | no |
