...
The serverless CA can be configured to deliver [notifications](notifications.md) to Slack.
...
3. enter the Slack OAuth token value, either via CI/CD or manually using the console
